...
// Check if admin is logged in and is from Peradeniya campus
if (!isset($_SESSION['admin_id']) || $_SESSION['user_type'] !== 'admin' || $_SESSION['campus'] !== 'University of Peradeniya') {
...
<head>
    ...
    <title>Peradeniya Admin Dashboard - EduConnect SL</title>
...
<body>
        ...
        <div class="main-content">
            ...
            <header class="top-bar">
                <div class="top-bar-left">
                    <h1>Peradeniya Campus Admin Dashboard</h1>
                </div>
            ...
            <main class="content-area">
                    ...
                    <div class="dashboard-grid">
                        <div class="dashboard-card">
                            <div class="card-header">
                                <h3 class="card-title">Peradeniya Students</h3>
                                <div class="card-icon primary">
                                    <i class="fas fa-users"></i>
                                </div>
                            </div>
                            <div class="card-value">20,500</div>
                            <p class="card-description">12,000 undergraduates + 8,500 postgraduates</p>
                        </div>

                        <div class="dashboard-card">
                            <div class="card-header">
                                <h3 class="card-title">Faculties & Institutes</h3>
                                <div class="card-icon success">
                                    <i class="fas fa-graduation-cap"></i>
                                </div>
                            </div>
                            <div class="card-value">13</div>
                            <p class="card-description">9 faculties + 4 postgraduate institutes</p>
                        </div>

                        <div class="dashboard-card">
                            <div class="card-header">
                                <h3 class="card-title">Campus Location</h3>
                                <div class="card-icon warning">
                                    <i class="fas fa-map-marker-alt"></i>
                                </div>
                            </div>
                            <div class="card-value">Peradeniya</div>
                            <p class="card-description">Main campus location</p>
                        </div>
                        ...
                        <div class="dashboard-card">
                            ...
                            <div class="card-value">1942</div>
                            <p class="card-description">University of Ceylon → Peradeniya (1978)</p>
                        </div>
                    </div>

                    <!-- Peradeniya Campus Info -->
                    <div class="table-container">
                        <div class="table-header">
                            <h3 class="table-title">University of Peradeniya Campus Information</h3>
                        </div>
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1rem;">
                            <div style="padding: 1rem; background: var(--light-color); border-radius: 0.5rem;">
                                <h4 style="color: var(--primary-color); margin-bottom: 0.5rem;">Location</h4>
                                <p>Peradeniya, Sri Lanka</p>
                            </div>
                            <div style="padding: 1rem; background: var(--light-color); border-radius: 0.5rem;">
                                <h4 style="color: var(--success-color); margin-bottom: 0.5rem;">Established</h4>
                                <p>1942 (University of Ceylon)<br>1978 (University of Peradeniya)</p>
                            </div>
                            <div style="padding: 1rem; background: var(--light-color); border-radius: 0.5rem;">
                                <h4 style="color: var(--warning-color); margin-bottom: 0.5rem;">Accreditation</h4>
                                <p>University Grants Commission (UGC) of Sri Lanka</p>
                            </div>
                            <div style="padding: 1rem; background: var(--light-color); border-radius: 0.5rem;">
                                <h4 style="color: var(--info-color); margin-bottom: 0.5rem;">Faculties</h4>
                                <p>Medicine, Agriculture, Arts, Science, Engineering, Dental Sciences, Veterinary Medicine, Management, Allied Health Sciences</p>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="study-level-card">
                            <div class="study-level-header">
                                <div class="study-level-info">
                                    ...
                                    <div class="study-level-details">
                                        <h3 class="study-level-title">Diploma</h3>
                                        <p class="study-level-description">Diploma programs for professional development</p>
                                    </div>
                                </div>
                                <div class="study-level-actions">
                                    <button class="btn-edit-study-level" onclick="editStudyLevel('Diploma')">
                                        <i class="fas fa-edit"></i>
                                        Edit
                                    </button>
                                    <button class="btn-add-program-primary" onclick="openAddProgramModal('Diploma')">
                                        <i class="fas fa-plus"></i>
                                        Add Program
                                    </button>
                                </div>
                            ...
                            <div class="programs-grid" id="diploma-programs">
                                <!-- Programs will be loaded here -->
                            </div>
                        </div>
                        
                        <!-- Professional Short Courses Level -->
                        <div class="study-level-card">
                            <div class="study-level-header">
                                <div class="study-level-info">
                                    <div class="study-level-icon">
                                    ...
                                    <div class="study-level-details">
                                        <h3 class="study-level-title">Professional Short Courses</h3>
                                        <p class="study-level-description">Short-term professional development courses</p>
                                    </div>
                                </div>
                                <div class="study-level-actions">
                                    <button class="btn-edit-study-level" onclick="editStudyLevel('Professional Short Courses')">
                                        <i class="fas fa-edit"></i>
                                        Edit
                                    </button>
                                    <button class="btn-add-program-primary" onclick="openAddProgramModal('Professional Short Courses')">
                                        <i class="fas fa-plus"></i>
                                        Add Program
                                    </button>
                                </div>
                            ...
                            <div class="programs-grid" id="short-courses-programs">
                                <!-- Programs will be loaded here -->
                            </div>
                        </div>
                ...
                <section id="students" class="dashboard-section" style="display: none;">
                    <div class="table-container">
                        <div class="table-header">
                            <h3 class="table-title">Peradeniya Student Directory</h3>
                        </div>
                            ...
                            <table class="data-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Sarah Johnson</td>
                                        <td>BBA</td>
                                        <td>sarah.johnson@pera.edu.lk</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Michael Brown</td>
                                        <td>MBA</td>
                                        <td>michael.brown@pera.edu.lk</td>
                ...
                <section id="enrollments" class="dashboard-section" style="display: none;">
                    <div class="table-container">
                        <div class="table-header">
                            <h3 class="table-title">Peradeniya Course Registration Requests</h3>
                        ...
                        <div id="enrollmentsTable">
                            ...
                            try {
                                ...
                                $stmt = $pdo->prepare("
                                    ...
                                    WHERE cr.campus = 'University of Peradeniya'
                                ...
                                <?php else: ?>
                                    <div class="no-data">
                                        <i class="fas fa-inbox"></i>
                                        <p>No course registrations found for Peradeniya Campus</p>
                                    </div>
                                <?php endif;
                            } catch (Exception $e) {
                ...
                <section id="applications" class="dashboard-section" style="display: none;">
                    <div class="table-container">
                        <div class="table-header">
                            <h3 class="table-title">Course Applications - Peradeniya Campus</h3>
                        ...
                        <div id="applicationsContent">
                            ...
                            try {
                                ...
                                $applicationsStmt = $pdo->prepare("
                                    ...
                                    WHERE ca.university = 'University of Peradeniya' OR ca.university = 'Peradeniya Campus'
                                ...
                                <?php else: ?>
                                    <div class="no-data">
                                        <i class="fas fa-file-alt"></i>
                                        <p>No course applications found for Peradeniya Campus</p>
                                    </div>
                                <?php endif;
                            } catch (Exception $e) {
                ...
                <section id="analytics" class="dashboard-section" style="display: none;">
                    ...
                    <div class="dashboard-grid">
                        <div class="dashboard-card">
                            <div class="card-header">
                                <h3 class="card-title">Total Enrolled Students</h3>
                                <div class="card-icon primary">
                                    <i class="fas fa-users"></i>
                                </div>
                            </div>
                        ...
                        <div class="dashboard-card">
                            <div class="card-header">
                                <h3 class="card-title">Active Faculties</h3>
                                <div class="card-icon success">
                                    <i class="fas fa-graduation-cap"></i>
                                </div>
                            </div>
                        ...
                        <div class="dashboard-card">
                            ...
                            <p class="card-description">Active research initiatives</p>
                        </div>
                        ...
                        <div class="dashboard-card">
                            ...
                            <p class="card-description">UGC approved programs</p>
                        </div>
                    </div>
                    ...
                    <div class="dashboard-grid">
                        <div class="dashboard-card">
                            <div class="card-header">
                                <h3 class="card-title">Enrollment Distribution by Faculty</h3>
                                <div class="chart-controls">
                                    <select id="enrollmentView" onchange="updateEnrollmentChart()">
                        ...
                        <div class="dashboard-card">
                            <div class="card-header">
                                <h3 class="card-title">Program Success Rates</h3>
                                <div class="chart-controls">
                                    <select id="successRateView" onchange="updateSuccessRateChart()">
                            ...
                            <div id="successRateChart" style="height: 400px; position: relative;">
                                <canvas id="successRateCanvas" width="400" height="400"></canvas>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dashboard-grid">
                        <div class="dashboard-card">
                            <div class="card-header">
                                ...
                                <div class="chart-controls">
                                    <select id="accreditationView" onchange="updateAccreditationChart()">
                                        <option value="status">Status Distribution</option>
                                        <option value="renewal">Renewal Timeline</option>
                        ...
                        <div class="dashboard-card">
                            <div class="card-header">
                                <h3 class="card-title">Research Output by Department</h3>
                                <div class="chart-controls">
                                    <select id="researchView" onchange="updateResearchChart()">
                            ...
                            <div id="researchChart" style="height: 400px; position: relative;">
                                <canvas id="researchCanvas" width="400" height="400"></canvas>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-container">
                        <div class="table-header">
                            <h3 class="table-title">Peradeniya Analytics Summary</h3>
                        </div>
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1rem;">
                            <div style="padding: 1rem; background: var(--light-color); border-radius: 0.5rem;">
                                <h4 style="color: var(--primary-color); margin-bottom: 0.5rem;">Enrollment Trends</h4>
                                <p>Steady growth in postgraduate enrollment (+12% YoY)</p>
                            </div>
                            <div style="padding: 1rem; background: var(--light-color); border-radius: 0.5rem;">
                                <h4 style="color: var(--success-color); margin-bottom: 0.5rem;">Program Performance</h4>
                                <p>Average graduation rate: 87% across all faculties</p>
                            </div>
                            <div style="padding: 1rem; background: var(--light-color); border-radius: 0.5rem;">
                                <h4 style="color: var(--warning-color); margin-bottom: 0.5rem;">Accreditation</h4>
                                <p>All programs maintain UGC accreditation status</p>
                            </div>
                            <div style="padding: 1rem; background: var(--light-color); border-radius: 0.5rem;">
                                <h4 style="color: var(--info-color); margin-bottom: 0.5rem;">Research Impact</h4>
                                <p>342 active projects, 1,247 publications in 2024</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section id="reviews" class="dashboard-section" style="display: none;">
                    <div class="table-container">
                        <div class="table-header">
                            ...
                            <p class="table-subtitle">Moderate student reviews and ratings for Peradeniya courses</p>
                        </div>
                ...
                <section id="inquiries" class="dashboard-section" style="display: none;">
                    <div class="table-container">
                        <div class="table-header">
                            ...
                            <p class="table-subtitle">Manage and respond to student inquiries for Peradeniya courses</p>
                        </div>
                ...
                <section id="content" class="dashboard-section" style="display: none;">
                    <div class="table-container">
                        <div class="table-header">
                            ...
                            <p class="table-subtitle">Create and manage articles, announcements, and content for Peradeniya students</p>
                        </div>
                ...
                <section id="settings" class="dashboard-section" style="display: none;">
                    <div class="table-container">
                        <div class="table-header">
                            <h3 class="table-title">Peradeniya Dashboard Settings</h3>
                        </div>
    ...
    <script>
        ...
        class PeradeniyaAdminDashboard {
            constructor() {
        ...
        function submitNewProgram(event) {
            ...
            formData.append('action', 'add_peradeniya_program');
            formData.append('level', currentStudyLevel);
            formData.append('program_code', 'PERA' + Date.now()); // Generate unique program code
        ...
        function submitNewCourse(event) {
            ...
            const formData = new FormData(form);
            formData.append('action', 'add_peradeniya_course');
        ...
        function loadProgramsByStudyLevel() {
            fetch('get_peradeniya_programs.php')
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
                        ...
                        const studyLevels = {
                            ...
                            'Professional Short Courses': 'short-courses-programs'
                        };
                        ...
                        Object.keys(studyLevels).forEach(level => {
                            ...
                            if (programs.length > 0) {
                                ...
                                container.innerHTML = '<div style="text-align: center; padding: 2rem; color: var(--secondary-color);"><i class="fas fa-folder-open" style="font-size: 1.5rem; margin-bottom: 0.5rem;"></i><p>No programs added yet</p></div>';
                            }
                        });
                    }
                })
        ...
        function loadCoursesForProgram(programId) {
            ...
            fetch('get_peradeniya_courses.php')
            .then(response => response.json())
            .then(data => {
                ...
                if (data.success) {
                        ...
                        if (programCourses.length > 0) {
                            ...
                            coursesContainer.innerHTML = '<div style="text-align: center; padding: 1rem; color: var(--secondary-color);"><i class="fas fa-book-open" style="font-size: 1rem; margin-bottom: 0.5rem;"></i><p>No courses added yet</p></div>';
                        }
                } else {
                        coursesContainer.innerHTML = '<div style="text-align: center; padding: 1rem; color: var(--secondary-color);"><i class="fas fa-book-open" style="font-size: 1rem; margin-bottom: 0.5rem;"></i><p>No courses added yet</p></div>';
                }
        ...
        function openAddStudyLevelModal() {
            alert('Add study level functionality will be implemented');
        }

        function editProgram(programId) {
            // Implement edit program functionality
            alert('Edit program functionality will be implemented here for ID: ' + programId);
        }
        ...
        function deleteProgram(programId) {
            if (confirm('Are you sure you want to delete this program? This will also delete all associated courses.')) {
                ...
                formData.append('action', 'delete_peradeniya_program');
        ...
        function editCourse(courseId) {
            ...
            alert('Edit course functionality will be implemented here for ID: ' + courseId);
        }
        ...
        function deleteCourse(courseId) {
            if (confirm('Are you sure you want to delete this course?')) {
                ...
                formData.append('action', 'delete_peradeniya_course');
        ...
        function loadReviews() {
            fetch('get_reviews.php?campus=Peradeniya Campus')
                .then(response => response.json())
                .then(data => {
        ...
        function loadInquiries() {
            fetch('get_inquiries.php?campus=University of Peradeniya')
                .then(response => response.json())
                .then(data => {
        ...
        function loadSettings() {
            ...
            const savedSettings = localStorage.getItem('peradeniyaAdminSettings');
            if (savedSettings) {
        ...
        function saveSettings() {
            ...
            localStorage.setItem('peradeniyaAdminSettings', JSON.stringify(settings));
        ...
        function loadAnnouncements() {
            ...
            const campus = encodeURIComponent('University of Peradeniya');
        ...
        let enrollmentChart, successRateChart, accreditationChart, researchChart;
        ...
        function initializeAnalyticsCharts() {
            ...
            const successRateCanvas = document.getElementById('successRateCanvas');
            ...
            if (!enrollmentCanvas || !successRateCanvas || !accreditationCanvas || !researchCanvas) {
                console.error('Canvas elements not found');
                return;
            }
            
            try {
                // Initialize Enrollment Distribution Chart
                const enrollmentCtx = enrollmentCanvas.getContext('2d');
                enrollmentChart = new Chart(enrollmentCtx, {
                    type: 'doughnut',
                    data: {
                        labels: ['Medicine', 'Engineering', 'Science', 'Arts', 'Agriculture', 'Management', 'Dental Sciences', 'Veterinary Medicine', 'Allied Health Sciences'],
                        datasets: [{
                            data: [2800, 3200, 2500, 1800, 1200, 1500, 800, 600, 700],
                            backgroundColor: [
                                '#1e40af', '#059669', '#f59e0b', '#ef4444', '#8b5cf6',
                ...
                console.error('Error initializing enrollment chart:', error);
            }

            try {
                // Initialize Program Success Rates Chart
                ...
                successRateChart = new Chart(successRateCtx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            data: [95, 88, 85, 82, 90, 87, 92, 89, 86],
            ...
            try {
                ...
                accreditationChart = new Chart(accreditationCtx, {
                    type: 'pie',
                    data: {
                        labels: ['Fully Accredited', 'Conditionally Accredited', 'Under Review', 'Pending Renewal'],
                        datasets: [{
                            data: [85, 10, 3, 2],
                            backgroundColor: ['#059669', '#f59e0b', '#ef4444', '#64748b'],
                            borderWidth: 2,
                            borderColor: '#ffffff'
                        }]
                    },
                ...
                console.log('Accreditation chart initialized');
            } catch (error) {
                console.error('Error initializing accreditation chart:', error);
            }

            try {
                // Initialize Research Output Chart
                const researchCtx = researchCanvas.getContext('2d');
                researchChart = new Chart(researchCtx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            data: [245, 189, 156, 98, 134, 87, 67, 45, 78],
                ...
                console.log('Research chart initialized');
            } catch (error) {
                console.error('Error initializing research chart:', error);
            }
        ...
        window.initializePeradeniyaCharts = function() {
            console.log('Manually initializing Peradeniya charts...');
            initializeAnalyticsCharts();
        };

        // Function to force chart initialization (for troubleshooting)
        window.forcePeradeniyaChartInit = function() {
            console.log('Force initializing Peradeniya charts...');
        ...
        function updateEnrollmentChart() {
            ...
            const data = {
                undergraduate: [2800, 3200, 2500, 1800, 1200, 1500, 800, 600, 700],
                postgraduate: [1200, 800, 600, 400, 300, 500, 200, 150, 250],
                total: [4000, 4000, 3100, 2200, 1500, 2000, 1000, 750, 950]
            };
            
            enrollmentChart.data.datasets[0].data = data[view];
            enrollmentChart.update();
        }

        function updateSuccessRateChart() {
            const view = document.getElementById('successRateView').value;
            const data = {
                graduation: [95, 88, 85, 82, 90, 87, 92, 89, 86],
                retention: [92, 85, 88, 79, 87, 84, 89, 86, 83],
                employment: [98, 94, 89, 85, 92, 90, 95, 88, 87]
            };
            ...
            successRateChart.data.datasets[0].data = data[view];
            successRateChart.data.datasets[0].label = labels[view];
            successRateChart.update();
        }

        function updateAccreditationChart() {
            const view = document.getElementById('accreditationView').value;
            
            if (view === 'status') {
                accreditationChart.data.labels = ['Fully Accredited', 'Conditionally Accredited', 'Under Review', 'Pending Renewal'];
                accreditationChart.data.datasets[0].data = [85, 10, 3, 2];
            } else if (view === 'renewal') {
                accreditationChart.data.labels = ['Renewed 2024', 'Due 2025', 'Due 2026', 'Due 2027'];
                accreditationChart.data.datasets[0].data = [45, 25, 20, 10];
            } else if (view === 'compliance') {
                accreditationChart.data.labels = ['Excellent (90-100%)', 'Good (80-89%)', 'Satisfactory (70-79%)', 'Needs Improvement (<70%)'];
                accreditationChart.data.datasets[0].data = [60, 25, 12, 3];
            }
        ...
        function updateResearchChart() {
            const view = document.getElementById('researchView').value;
            const data = {
                publications: [245, 189, 156, 98, 134, 87, 67, 45, 78],
                citations: [1847, 1234, 987, 456, 789, 543, 321, 234, 456],
                grants: [23, 18, 15, 8, 12, 9, 6, 4, 7]
            };
            
            const labels = {
                publications: 'Publications (2024)',
                citations: 'Citations (2024)',
                grants: 'Research Grants (2024)'
            };
            
            researchChart.data.datasets[0].data = data[view];
            researchChart.data.datasets[0].label = labels[view];
            researchChart.update();
        }

        // Initialize dashboard when page loads
        document.addEventListener('DOMContentLoaded', () => {
            new PeradeniyaAdminDashboard();
            
            // Load announcements when page loads
            loadAnnouncements();
            
            // Load programs when courses section is shown
            document.querySelector('[data-section="courses"]').addEventListener('click', () => {
                setTimeout(loadProgramsByStudyLevel, 100);
            });
            
            // Load reviews when reviews section is shown
            document.querySelector('[data-section="reviews"]').addEventListener('click', () => {
                setTimeout(loadReviews, 100);
            });

            // Load inquiries when inquiries section is shown
            document.querySelector('[data-section="inquiries"]').addEventListener('click', () => {
                setTimeout(loadInquiries, 100);
            });
            ...
            setTimeout(() => {
                ...
                if (analyticsSection && analyticsSection.style.display !== 'none' && !enrollmentChart) {
                    console.log('Analytics section is visible, initializing charts...');
                    initializeAnalyticsCharts();
                }
            }, 500);
        });
    ...
    <div id="addProgramModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Add New Peradeniya Program</h3>
