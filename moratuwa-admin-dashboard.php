...
// Check if admin is logged in and is from Moratuwa campus
if (!isset($_SESSION['admin_id']) || $_SESSION['user_type'] !== 'admin' || $_SESSION['campus'] !== 'University of Moratuwa') {
...
<head>
    ...
    <title>Moratuwa Admin Dashboard - EduConnect SL</title>
...
<body>
    <div class="dashboard-container">
        ...
        <nav class="sidebar" id="sidebar">
            <div class="sidebar-header">
                <h2>Moratuwa Campus</h2>
                <p>Admin Dashboard</p>
            </div>
            
            <div class="sidebar-nav">
                <div class="nav-item">
                    <a href="#overview" class="nav-link active" data-section="overview" onclick="showSectionFallback('overview'); return false;">
                        <i class="fas fa-chart-line"></i>
                        Overview
                    </a>
                </div>
                <div class="nav-item">
                    <a href="#courses" class="nav-link" data-section="courses" onclick="showSectionFallback('courses'); return false;">
                ...
                <div class="nav-item">
                    <a href="#applications" class="nav-link" data-section="applications" onclick="showSectionFallback('applications'); return false;">
                        <i class="fas fa-file-alt"></i>
                        Course Applications
                    </a>
                </div>
                <div class="nav-item">
                    <a href="#analytics" class="nav-link" data-section="analytics" onclick="showSectionFallback('analytics'); return false;">
                ...
                <div class="nav-item">
                    <a href="#inquiries" class="nav-link" data-section="inquiries" onclick="showSectionFallback('inquiries'); return false;">
                        <i class="fas fa-inbox"></i>
                        Inquiry Management
                    </a>
                </div>
                <div class="nav-item">
                    <a href="#content" class="nav-link" data-section="content" onclick="showSectionFallback('content'); return false;">
                        <i class="fas fa-file-alt"></i>
                        Content Management
                    </a>
                </div>
        ...
        <div class="main-content">
            ...
            <header class="top-bar">
                <div class="top-bar-left">
                    <h1>Moratuwa Campus Admin Dashboard</h1>
                </div>
            ...
            <main class="content-area">
                    ...
                    <div class="dashboard-grid">
                        <div class="dashboard-card">
                            <div class="card-header">
                                <h3 class="card-title">Moratuwa Students</h3>
                                <div class="card-icon primary">
                                    <i class="fas fa-users"></i>
                                </div>
                            </div>
                            <div class="card-value">12,000</div>
                            <p class="card-description">Undergraduate and postgraduate students</p>
                        </div>

                        <div class="dashboard-card">
                            <div class="card-header">
                                <h3 class="card-title">Programs Offered</h3>
                                <div class="card-icon success">
                                    <i class="fas fa-graduation-cap"></i>
                                </div>
                            </div>
                            <div class="card-value">4</div>
                            <p class="card-description">Engineering, Architecture, Design, and IT</p>
                        </div>

                        <div class="dashboard-card">
                            <div class="card-header">
                                <h3 class="card-title">Graduation Success</h3>
                                <div class="card-icon warning">
                                    <i class="fas fa-trophy"></i>
                                </div>
                            </div>
                            <div class="card-value">95%</div>
                            <p class="card-description">2022 graduation rate within minimum time</p>
                        </div>
                        ...
                        <div class="dashboard-card">
                            ...
                            <div class="card-value">Katubedda</div>
                            <p class="card-description">Main campus in Moratuwa</p>
                        </div>
                    </div>

                    <!-- Moratuwa Campus Info -->
                    <div class="table-container">
                        <div class="table-header">
                            <h3 class="table-title">University of Moratuwa Campus Information</h3>
                        </div>
                ...
                <section id="students" class="dashboard-section" style="display: none;">
                    <div class="table-container">
                        <div class="table-header">
                            <h3 class="table-title">Moratuwa Student Directory</h3>
                        </div>
                            ...
                            <table class="data-table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Sarah Johnson</td>
                                        <td>BBA</td>
                                        <td>sarah.johnson@moratuwa.edu.lk</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Michael Brown</td>
                                        <td>MBA</td>
                                        <td>michael.brown@moratuwa.edu.lk</td>
                ...
                <section id="enrollments" class="dashboard-section" style="display: none;">
                    <div class="table-container">
                        <div class="table-header">
                            <h3 class="table-title">Moratuwa Course Registration Requests</h3>
                        ...
                        <div id="enrollmentsTable">
                            ...
                            try {
                                ...
                                <?php else: ?>
                                    <div class="no-data">
                                        <i class="fas fa-inbox"></i>
                                        <p>No course registrations found for Moratuwa Campus</p>
                                    </div>
                                <?php endif;
                            } catch (Exception $e) {
                ...
                <section id="applications" class="dashboard-section" style="display: none;">
                    <div class="table-container">
                        <div class="table-header">
                            <h3 class="table-title">Course Applications - Moratuwa Campus</h3>
                        ...
                        <div id="applicationsContent">
                            <?php
                            try {
                                // Fetch course applications for Moratuwa campus
                                $applicationsStmt = $pdo->prepare("
                                    ...
                                    WHERE ca.university = 'Moratuwa' OR ca.university = 'University of Moratuwa'
                                ...
                                <?php else: ?>
                                    <div class="no-data">
                                        <i class="fas fa-file-alt"></i>
                                        <p>No course applications found for Moratuwa Campus</p>
                                    </div>
                                <?php endif;
                            } catch (Exception $e) {
                ...
                <section id="analytics" class="dashboard-section" style="display: none;">
                    ...
                    <div class="dashboard-grid">
                        ...
                        <div class="dashboard-card">
                            <div class="card-header">
                                <h3 class="card-title">Active Programs</h3>
                                <div class="card-icon success">
                                    <i class="fas fa-graduation-cap"></i>
                                </div>
                            </div>
                    ...
                    <div class="dashboard-grid">
                        <div class="dashboard-card">
                            <div class="card-header">
                                ...
                                <div class="card-actions">
                                    <select id="enrollmentPeriod" onchange="loadEnrollmentTrends()">
                            ...
                            <div id="enrollmentChart" style="height: 300px; position: relative;">
                        ...
                        <div class="dashboard-card">
                            <div class="card-header">
                                <h3 class="card-title">Program Popularity</h3>
                                <div class="card-actions">
                                    <select id="programPeriod" onchange="loadProgramPopularity()">
                            ...
                            <div id="popularProgramsChart" style="height: 300px; position: relative;">
                                <canvas id="programPopularityChart"></canvas>
                            </div>
                        </div>
                    </div>
                    
                    <!-- Research & Accreditation Analytics -->
                    ...
                    <div class="dashboard-grid" style="margin-top: 2rem;">
                        <div class="dashboard-card">
                            <div class="card-header">
                                <h3 class="card-title">Program Performance Metrics</h3>
                            </div>
                                ...
                                <table class="data-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>8,500</td>
                                            <td><span style="color: var(--success-color);">94%</span></td>
                                            <td>89 projects</td>
                                            <td><span style="color: var(--success-color);">✓ Active</span></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>1,200</td>
                                            <td><span style="color: var(--success-color);">96%</span></td>
                                            <td>23 projects</td>
                                            <td><span style="color: var(--success-color);">✓ Active</span></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>1,100</td>
                                            <td><span style="color: var(--success-color);">92%</span></td>
                                            <td>18 projects</td>
                                            <td><span style="color: var(--success-color);">✓ Active</span></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>1,200</td>
                                            <td><span style="color: var(--success-color);">95%</span></td>
                                            <td>26 projects</td>
                                            <td><span style="color: var(--success-color);">✓ Active</span></td>
                                        </tr>
                                    </tbody>
                        ...
                        <div class="dashboard-card">
                            <div class="card-header">
                                <h3 class="card-title">Campus Statistics</h3>
                            </div>
                            <div style="padding: 1.5rem;">
                                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1.5rem;">
                                    <div style="text-align: center; padding: 1rem; background: var(--light-color); border-radius: 0.5rem;">
                                        <div style="font-size: 1.5rem; font-weight: 700; color: var(--primary-color);">1972</div>
                                        <div style="font-size: 0.875rem; color: var(--secondary-color);">Established</div>
                                    </div>
                                    <div style="text-align: center; padding: 1rem; background: var(--light-color); border-radius: 0.5rem;">
                                        <div style="font-size: 1.5rem; font-weight: 700; color: var(--success-color);">Katubedda</div>
                                        <div style="font-size: 0.875rem; color: var(--secondary-color);">Main Campus</div>
                                    </div>
                                </div>
                                <div style="text-align: center; padding: 1rem; background: var(--light-color); border-radius: 0.5rem; margin-bottom: 1rem;">
                                    <div style="font-size: 1.5rem; font-weight: 700; color: var(--warning-color);">UGC Approved</div>
                                    <div style="font-size: 0.875rem; color: var(--secondary-color);">Accreditation Status</div>
                                </div>
                                <div style="text-align: center; padding: 1rem; background: var(--light-color); border-radius: 0.5rem;">
                                    <div style="font-size: 1.5rem; font-weight: 700; color: var(--info-color);">Engineering & Technology</div>
                                    <div style="font-size: 0.875rem; color: var(--secondary-color);">Specialization Focus</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id="reviews" class="dashboard-section" style="display: none;">
                    <div class="table-container">
                        <div class="table-header">
                            ...
                            <p class="table-subtitle">Moderate student reviews and ratings for Moratuwa courses</p>
                        </div>
                ...
                <section id="inquiries" class="dashboard-section" style="display: none;">
                    <div class="table-container">
                        <div class="table-header">
                            ...
                            <p class="table-subtitle">Manage and respond to student inquiries for Moratuwa courses</p>
                        </div>
                ...
                <section id="content" class="dashboard-section" style="display: none;">
                    <div class="table-container">
                        <div class="table-header">
                            ...
                            <p class="table-subtitle">Create and manage articles, announcements, and content for Moratuwa students</p>
                        </div>
                ...
                <section id="settings" class="dashboard-section" style="display: none;">
                    <div class="table-container">
                        <div class="table-header">
                            <h3 class="table-title">Moratuwa Dashboard Settings</h3>
                        </div>
    ...
    <script>
        // CRITICAL: Define navigation function FIRST before any other code
        function showSectionFallback(sectionName) {
            console.log('showSectionFallback called with:', sectionName);
        ...
        window.showSectionFallback = showSectionFallback;

        // Dashboard functionality
        class MoratuwaAdminDashboard {
            constructor() {
        ...
        function submitNewProgram(event) {
            ...
            formData.append('action', 'add_moratuwa_program');
            formData.append('level', currentStudyLevel);
            formData.append('program_code', 'MOR' + Date.now()); // Generate unique program code
        ...
        function submitNewCourse(event) {
            ...
            const formData = new FormData(form);
            formData.append('action', 'add_moratuwa_course');
        ...
        function loadProgramsByStudyLevel() {
            fetch('get_moratuwa_programs.php')
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
        ...
        function loadCoursesForProgram(programId) {
            ...
            fetch('get_moratuwa_courses.php')
            .then(response => response.json())
            .then(data => {
        ...
        function deleteProgram(programId) {
            if (confirm('Are you sure you want to delete this program? This will also delete all associated courses.')) {
                ...
                formData.append('action', 'delete_moratuwa_program');
        ...
        function deleteCourse(courseId) {
            if (confirm('Are you sure you want to delete this course?')) {
                ...
                formData.append('action', 'delete_moratuwa_course');
        ...
        function loadReviews() {
            fetch('get_reviews.php?campus=Moratuwa Campus')
                .then(response => response.json())
                .then(data => {
        ...
        function loadInquiries() {
            fetch('get_inquiries.php?campus=Moratuwa')
                .then(response => response.json())
                .then(data => {
        ...
        function loadSettings() {
            ...
            const savedSettings = localStorage.getItem('moratuwaAdminSettings');
            if (savedSettings) {
        ...
        function saveSettings() {
            ...
            localStorage.setItem('moratuwaAdminSettings', JSON.stringify(settings));
        ...
        function loadAnnouncements() {
            ...
            const campus = encodeURIComponent('University of Moratuwa');
        ...
        // Analytics Functions
        let enrollmentChart, programChart;
        ...
        function loadEnrollmentTrends() {
            ...
            if (period === 'yearly') {
                ...
                data = [10500, 10800, 11000, 11200, 11500, 12000];
            } else if (period === 'monthly') {
                labels = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
                data = [11800, 11850, 11900, 11950, 12000, 12000, 12000, 12000, 12000, 12000, 12000, 12000];
            } else {
                labels = ['Sem 1 2023', 'Sem 2 2023', 'Sem 1 2024', 'Sem 2 2024'];
                data = [11500, 11700, 11900, 12000];
            }
        ...
        function loadProgramPopularity() {
            ...
            const data = {
                labels: ['Engineering', 'Architecture', 'Design', 'Information Technology'],
                datasets: [{
                    data: [8500, 1200, 1100, 1200],
                    backgroundColor: [
                        '#0f766e',
                        '#059669',
                        '#f59e0b',
        ...
        function initializeAnalytics() {
            setTimeout(() => {
                ...
                loadProgramPopularity();
            }, 100);
        }

        // Initialize dashboard when page loads
        document.addEventListener('DOMContentLoaded', () => {
            new MoratuwaAdminDashboard();
            ...
            document.querySelector('[data-section="analytics"]').addEventListener('click', () => {
                initializeAnalytics();
            });
        });
    </script>
    ...
    <div id="addProgramModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Add New Moratuwa Program</h3>
