...
// University of Moratuwa Study Levels Data
$study_levels = [
    'Faculty of Information Technology' => [
        'count' => 3,
        'description' => 'IT-focused programs and certificate courses'
    ],
    'Institute of Technology (ITUM)' => [
        'count' => 3,
        'description' => 'Technology and engineering short courses'
    ],
    'Department of Mechanical Engineering' => [
        'count' => 2,
        'description' => 'Mechanical engineering training courses'
    ],
...
<head>
    ...
    <title>University of Moratuwa - Study Levels - EduConnectSL</title>
...
<body>
    ...
    <section class="study-levels-content">
        <div class="container">
            ...
            <div class="page-title">
                <h2>
                    <span class="university-name">University of Moratuwa</span> - <span class="study-levels-text">Study Levels</span>
                </h2>
            ...
            <div class="study-levels-grid">
                <?php 
                $card_images = [
                    'Faculty of Information Technology' => 'img/Moratuwa_program/informatio_technology.jpg',
                    'Institute of Technology (ITUM)' => 'img/Moratuwa_program/Institute of Technology.jpg',
                    'Department of Mechanical Engineering' => 'img/Moratuwa_program/Mechanical Engineering Programs.jpg',
                    'Department of Decision Sciences' => 'img/Moratuwa_program/Decision Sciences Programs.jpg'
                ];
    ...
    <script>
        function selectStudyLevel(studyLevel) {
            ...
            window.location.href = `Moratuwa_programs.php?level=${encodeURIComponent(studyLevel)}`;
        }
