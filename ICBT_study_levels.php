...
$study_levels = [
    ...
    'Undergraduate' => [
        'count' => 12,
        'description' => 'Bachelor degree programs for high school graduates'
    ],
    'After O/L & A/L' => [
        'count' => 11,
        'description' => 'Foundation and diploma programs for O/L and A/L students'
    ]
];
?>
...
<head>
    ...
    <title>ICBT Campus - Study Levels - EduConnectSL</title>
...
<body>
    ...
    <section class="study-levels-content">
        <div class="container">
            ...
            <div class="page-title">
                <h2>
                    <span class="university-name">ICBT Campus</span> - <span class="study-levels-text">Study Levels</span>
                </h2>
            ...
            <div class="study-levels-grid">
                <?php 
                $card_images = [
                    'Postgraduate' => 'img/ICBT_Program/postgraduate.jpg',
                    'Undergraduate' => 'img/ICBT_Program/undergraduate.png',
                    'After O/L & A/L' => 'img/ICBT_Program/after OL & AL.jpg'
                ];
    ...
    <script>
        function selectStudyLevel(studyLevel) {
            ...
            window.location.href = `ICBT_programs.php?level=${encodeURIComponent(studyLevel)}`;
        }
